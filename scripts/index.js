...
const popupProfileCloseBtn = document.querySelector('.profile__close-btn');
const popupPlaceCloseBtn = document.querySelector('.place__close-btn');
const popupImgCloseBtn = document.querySelector('.img__close-btn');
