...
const popupProfileCloseBtn = document.querySelector('.profile-close-btn');
const popupPlaceCloseBtn = document.querySelector('.place-close-btn');
const popupImgCloseBtn = document.querySelector('.img-close-btn');
